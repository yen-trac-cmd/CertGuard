...
def check_cert_chain_revocation(cert_chain: list[x509.Certificate], skip_leaf: bool, stapled_response, timeout: int = 10) -> Tuple[bool, str, Optional[int], Optional[str], Optional[str]]:
    """
